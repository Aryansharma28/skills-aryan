...
| [`explain-pr/`](./explain-pr) | posts an exhaustive PR walkthrough: behavior, motivation, every changed file, verification, risks, and concrete value toward a secure, scalable, runnable product. |
